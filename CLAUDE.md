...
- **실시간 모니터링 (M6)**: 평일 09:00~10:30 자동, 주도주 + 사용자 종목 1~2초 갱신, 텔레그램 메시지 편집 방식
...
| 시점 | 채널 | 내용 |
|---|---|---|
| **09:00~10:30 (평일)** | **텔레그램 (메시지 편집)** | **실시간 모니터링 — 주도주/사용자 종목 1~2초 갱신** ★ |
...
| 모니터링 알림 (부상/교체/이탈) | 텔레그램 | TRANSITION/GRACE 진입, 가속/이탈 임계 초과 시 별도 푸시 |
